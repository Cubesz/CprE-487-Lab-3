...
create_clock -period 5.000 -name main -waveform {0.000 2.500} [get_ports ACLK]


set_property BEL A6LUT [get_cells SD_AXIS_TREADY_OBUF_inst_i_1]
set_property LOC SLICE_X11Y28 [get_cells SD_AXIS_TREADY_OBUF_inst_i_1]

set_property BEL A5FF [get_cells output_ready_reg]
set_property LOC SLICE_X11Y28 [get_cells output_ready_reg]
