...
large_filter = np.fromfile("layer1_weights_8q_t_new.bin", dtype=np.int8, count=3200).reshape((4, 32, 5, 5))
large_bias = np.fromfile("biases_8q.bin", dtype=np.int16).reshape((32))
convolve(big_inputs.large_input, large_filter, large_bias, 0x00609664 & 0xFFFFC000, -2, False, True, 0)
