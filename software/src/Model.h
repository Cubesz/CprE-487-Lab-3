...
namespace ML
{
    ...
    public:
        ...
        const LayerData &inferenceLayer(const LayerData &inData, const int layerNum, const Layer::InfType infType = Layer::InfType::NAIVE, const QParams qparam = {0}, size_t tileSize = 2, size_t threadCount = 4) const;
        ...
        void addLayer(Args &&...args) { layers.emplace_back(new T(std::forward<Args>(args)...)); }
